  ...
  return (
    <main className="min-h-screen pb-10" style={bgStyle}>
      <div className="mx-auto max-w-md px-4 pt-4">
        ...
        {/* 棋盤 */}
        <div className="mt-3">
          <ChessBoard board={board} onMove={handleMove} lastMove={lastMove} boardSkinSrc={getActiveBoardSkinSrc(user.activeBoardSkin)} lineColor={getBoardLineColor(user.activeBoardSkin)} />
        </div>
